...
#define COCOAPODS_VERSION_PATCH_RestKit_Network 4
...
#define COCOAPODS_VERSION_PATCH_RestKit_ObjectMapping 4
...
#define COCOAPODS_VERSION_PATCH_RestKit_Support 4
